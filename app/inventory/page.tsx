  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1">
        <Header title="Inventory Management" role="admin" username="admin" />
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
            ...
            <TabsContent value="categories">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    <CardTitle>Laundry Categories</CardTitle>
                    <CardDescription>Manage the categories of laundry items</CardDescription>
                  </div>
              ...
              <Dialog open={isAddingCategory} onOpenChange={setIsAddingCategory}>
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>Create a new category for laundry items</DialogDescription>
                  </DialogHeader>
                  <form onSubmit={handleAddCategory}>
                    <div className="space-y-4 py-4">
                      <div className="space-y-2">
                        <Label htmlFor="categoryName">Category Name</Label>
                        <Input id="categoryName" name="categoryName" placeholder="Enter category name" required />
                      </div>
                    </div>
                    <DialogFooter>
            ...
            <TabsContent value="items">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    <CardTitle>Laundry Items & Pricing</CardTitle>
                    <CardDescription>Manage the items and their prices</CardDescription>
                  </div>
                  ...
                  <form onSubmit={handleAddItem}>
                    <div className="space-y-4 py-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="itemName" name="itemName" placeholder="Enter item name" required />
                      </div>
                      <div className="space-y-2">
              ...
              <Dialog open={isEditingItem} onOpenChange={setIsEditingItem}>
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>Update the item details and pricing</DialogDescription>
                  </DialogHeader>
                  {selectedItem && (
                    <form onSubmit={handleEditItem}>
                      ...
                      <DialogFooter>
                        <Button type="button" variant="outline" onClick={() => setIsEditingItem(false)}>
                          Cancel
                        </Button>
                        <Button type="submit">
                          <Save className="mr-2 h-4 w-4" />
