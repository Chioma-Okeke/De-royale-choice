...
import { BarChart, Calendar, DollarSign, ShoppingBag, ShirtIcon as Tshirt, Users } from "lucide-react"
            ...
            <TabsContent value="overview" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Overview of the latest customer transactions</CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>
                    <TableHeader>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Current inventory categories and items</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium">Curtains</span>
                        <span className="text-sm">8 items</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium">Others</span>
                        <span className="text-sm">15 items</span>
                      </div>
                    </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Today's laundry activity summary</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                ...
                <CardContent className="h-[400px] flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                      Detailed analytics charts and metrics would be displayed here.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="h-[400px] flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                      Daily, weekly, and monthly reports would be available here.
                    </p>
                  </div>
                </CardContent>
              </Card>
