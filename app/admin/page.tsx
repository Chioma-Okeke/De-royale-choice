                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="text-center mb-16">
                        ...
                        <p className="max-w-2xl mx-auto text-xl text-gray-500">
                            Track items, print receipts, and manage your laundry
                            business with ease.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        <Card>
                            ...
                            <CardContent>
                                <CardDescription>
                                    Register customers with unique IDs and keep
                                    track of all their items securely.
                                </CardDescription>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <CardDescription>
                                    Print professional receipts and item tags
                                    for easy organization and tracking.
                                </CardDescription>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <CardDescription>
                                    Quickly find any transaction by customer
                                    name, phone number, or registration ID.
                                </CardDescription>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <CardDescription>
                                    Access organized daily entry tables with
                        ...
                        <Card className="md:col-span-2">
                            ...
                            <CardContent>
                                <CardDescription className="mb-4">
                                    Log in to access your dashboard and start
                                    managing your laundry inventory.
                                </CardDescription>
